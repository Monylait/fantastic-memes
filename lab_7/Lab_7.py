...
mes=""
H=""
PKCS_7=[1,"DigAlId","Document","Open_Key","None",1,"FIO","Dig_AlId2","None","RSAdsi","SignatureValue","TimeStamp","SetOfAtributeValue"]
while flag:
    ...
    if point == "1":
        ...
        flag_3=True
        while flag_3:
            type = str(input("Выберите тип хеширования, для уменьшения размера ЦП\n>> SHA 256 - 1\n>> SHA 512 - 2\n>> STR 256 - 3\n>> STR 512 - 4\n>>> "))
            if type=="1":
                H=SHA.sha256(mes)
                PKCS_7[1]="SHA256"
                PKCS_7[7]="SHA256"
